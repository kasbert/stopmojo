...
/*		
		m_vSplitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, 
                                  m_roto1Panel = makeRoto1Panel(),
				                          m_roto2Panel = makeRoto2Panel());
...
//		p.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED), "Composite"));
  	p.setLayout(new BorderLayout());
...
//  	m_prevFrameAlphaSlider.setMinorTickSpacing(1);
  	...
  	m_prevFrameAlphaSlider.setPaintLabels(true);
		...
		m_prevFrameOffsetSpinner = new JSpinner(new SpinnerNumberModel(new Integer(-1),
...
//  	m_mainAlphaSlider.setMinorTickSpacing(0);
    ...
    mp.addField("Alpha (%):", m_mainAlphaSlider, 100);
		...
		m_curFrameSpinner = new JSpinner(new SpinnerNumberModel(new Integer(curFrame),
				                                                           new Integer(0), new Integer(999999),
																																	 new Integer(1)));
...
*/
  ...
  {
  	PreviewDialog
		  d = new PreviewDialog(this, m_prj, "Preview");
